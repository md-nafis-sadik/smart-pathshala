  ...
  return (
    <section ref={sectionRef} className='bg-[#FFFBEA]'>
      ...
      <div className='containerX py-16 md:py-[120px] space-y-12'>
        <div>
        <div className="flex justify-center w-full"><TextFadeIn text="Benefits" className=" text-2xl md:text-4xl lg:text-[48px] font-[700] !leading-[1.2] text-text-850 tracking-wide mb-6"
        /></div>
