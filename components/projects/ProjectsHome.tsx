...
export default function ProjectsHome() {
  return (
    <section className="containerX py-20 md:py-[250px] flex flex-col-reverse md:flex-row items-center justify-between gap-12 relative">
      {/* Left: Text */}
      ...
      <div className="w-full md:w-2/3 relative flex justify-center items-center">
        ...
        <div className="absolute w-full md:w-[600px] lg::w-[712px] aspect-square bg-sky-100/40 rounded-full z-0" />
        {/* Overlapping Image */}
        <Image
          ...
          width={681}
          height={381}
          className="relative z-10 w-[681px] h-auto"
          priority
        />
      </div>
    </section>
